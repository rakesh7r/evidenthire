...
export default function ApplicationModal({ position, onClose }: ApplicationModalProps) {
	...
	return (
		<div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
			...
			{/* Modal */}
			<div className='relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white dark:bg-slate-900 shadow-2xl transition-all animate-in fade-in zoom-in-95 duration-300'>
				{/* Success State */}
				{isSuccess ? (
					<div className='flex flex-col items-center justify-center p-12'>
						<div className='flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 shadow-lg shadow-emerald-500/25 mb-6 animate-in zoom-in duration-300'>
					...
					<>
						{/* Header */}
						<div className='relative border-b border-slate-200 dark:border-slate-800 bg-gradient-to-r from-orange-500/10 to-purple-500/10 p-6'>
							<button
								onClick={onClose}
