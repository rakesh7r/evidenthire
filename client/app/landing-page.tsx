...
import { ArrowRight, Bot, CheckCircle, FileText, LineChart, Mic, ShieldCheck, Users } from 'lucide-react';
					...
					<div className='flex items-center gap-4'>
						{user ? (
							<div className='flex items-center gap-4'>
								...
								<form action={signOut}>
									<button className='rounded-full bg-slate-800 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-slate-700'>
										Sign Out
									</button>
								</form>
							</div>
				...
				<section className='relative overflow-hidden bg-slate-900 pt-20 pb-32 lg:pt-32'>
					...
					<div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center'>
						...
						<div className='mt-10 flex justify-center gap-4'>
							<Link
								href={user ? '#' : isWaitlist ? '#waitlist' : '/login'}
