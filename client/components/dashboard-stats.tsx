...
export default function DashboardStats() {
	...
	return (
		<div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
			...
			<div className='group rounded-xl border border-slate-700 bg-slate-800 p-6 shadow-sm transition-all hover:border-slate-600 hover:bg-slate-750'>
				<div className='flex items-center justify-between'>
					<div>
						<p className='text-sm font-medium text-slate-400'>Total Interviews</p>
						<p className='mt-1 text-2xl font-semibold text-white'>{stats.total_interviews}</p>
					</div>
			...
			<div className='group rounded-xl border border-slate-700 bg-slate-800 p-6 shadow-sm transition-all hover:border-slate-600 hover:bg-slate-750'>
				<div className='flex items-center justify-between'>
					<div>
						...
						<p className='mt-1 text-2xl font-semibold text-white'>{stats.pending_reviews}</p>
					</div>
				...
				<div className='mt-4 flex items-center text-sm text-orange-500/80'>
			...
			<div className='group rounded-xl border border-slate-700 bg-slate-800 p-6 shadow-sm transition-all hover:border-slate-600 hover:bg-slate-750'>
				<div className='flex items-center justify-between'>
					<div>
						...
						<p className='mt-1 text-2xl font-semibold text-white'>{stats.open_positions}</p>
					</div>
