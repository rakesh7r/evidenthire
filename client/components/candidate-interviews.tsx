		...
		<div className='space-y-6'>
			...
			<div className='relative'>
				...
				<input
					...
					className='w-full rounded-xl border border-slate-800 bg-slate-900/50 py-3 pl-10 pr-4 text-sm text-white placeholder-slate-500 transition-all focus:border-orange-500/50 focus:outline-none focus:ring-1 focus:ring-orange-500/50'
				/>
			</div>
			...
			<div className='space-y-4'>
				{filteredCandidates.map((candidate) => (
					<div
						key={candidate.id}
						className='overflow-hidden rounded-xl border border-slate-800 bg-slate-900/40 transition-all hover:bg-slate-900/60'>
						{/* Candidate Header */}
						<div
							className='flex cursor-pointer items-center justify-between p-5'
							onClick={() => toggleExpand(candidate.id)}>
							<div className='flex items-center gap-4'>
								<div className='flex h-12 w-12 items-center justify-center rounded-full bg-orange-500/10 text-orange-500 border border-orange-500/20'>
							...
							<div className='flex items-center gap-6'>
								...
								<div className='hidden md:block text-right'>
									<p className='text-xs uppercase tracking-wider text-slate-500 font-bold mb-1'>Rounds</p>
									<p className='text-sm font-medium text-white'>{candidate.interviews.length}</p>
								</div>
								<div
						...
						{expandedCandidate === candidate.id && (
							<div className='border-t border-slate-800 bg-slate-950/30 p-5 space-y-4'>
											...
											<div className='flex flex-col md:flex-row md:items-start justify-between gap-4'>
												<div className='flex-1'>
													<div className='flex items-center gap-3 mb-2'>
														<h5 className='text-base font-semibold text-white'>{interview.type}</h5>
														<span
													...
													<div className='grid grid-cols-1 md:grid-cols-2 gap-y-2 gap-x-6 text-sm text-slate-400 mb-4'>
													...
													<div className='rounded-lg bg-slate-950/50 p-4 border border-slate-800/50'>
														...
														<p className='text-sm text-slate-300 italic'>"{interview.analysis}"</p>
													</div>
												</div>
												...
												<div className='flex flex-col gap-2 shrink-0 md:min-w-[160px]'>
													...
													<button className='flex items-center justify-center gap-2 rounded-lg bg-slate-800 px-4 py-2 text-xs font-bold text-slate-200 transition-all hover:bg-slate-700 border border-slate-700'>
